...
// Daarna:   <script src="affiliate-components-v2.js"></script>
//
...
// <script>
//   renderAffiliateRequirementsListV2("benodigdheden", {
//     title: "Benodigdheden",
...
(function () {
  ...
  window.renderAffiliateRequirementsListV2 = function (targetId, config) {
    const target = document.getElementById(targetId);
